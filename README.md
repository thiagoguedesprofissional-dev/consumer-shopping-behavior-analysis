Consumer Insights & Shopping Behavior Analysis 🛒📊
📋 Sobre o Projeto
...
🛠️ Tecnologias e Ferramentas
    ...
    Power BI: Desenvolvimento de Dashboard interativo com foco em KPIs executivos.

    LaTeX: Redação do relatório técnico e estratégico de nível pleno.
...
📈 Principais Insights Extraídos
    ...
    Saúde da Base (LTV): Clientes fiéis (mais de 30 compras) são responsáveis pela maior fatia da receita acumulada, sugerindo estratégias de upselling para este grupo.

    Logística como Alavanca: Identificou-se que métodos de envio expressos estão correlacionados a um ticket médio superior, validando o frete rápido como benefício para clientes premium.
...
📁 Estrutura do Repositório
    ...
    /Dashboard: Arquivo .pbix e PDF do dashboard interativo.

    /Relatorio: Documento final com a análise estratégica detalhada (PDF/LaTeX).
...
Desenvolvido por Seu Nome – www.linkedin.com/in/thiago-guedes-161086139 – thiago.guedes.profissional@gmail.com
